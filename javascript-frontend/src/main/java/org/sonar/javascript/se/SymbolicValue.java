...
public class SymbolicValue {
  ...
  public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + (alwaysNullOrUndefined ? 1231 : 1237);
    result = prime * result + ((truthiness == null) ? 0 : truthiness.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (alwaysNullOrUndefined != other.alwaysNullOrUndefined)
      return false;
